...
{
    public partial class Frmdsds : Form
    {
        ...
        public void listar()
        {
            ...
            dgvListaProducto.Columns["precioCompra"].HeaderText = "PRECIO COMPRA";
            dgvListaProducto.Columns["precioVenta"].HeaderText = "PRECIO VENTA";
			dgvListaProducto.Columns["usuarioRegistro"].HeaderText = "USUARIO REGISTRO";
			dgvListaProducto.Columns["fechaRegistro"].HeaderText = "FECHA DE REGÍSTRO";
        ...
        {
			dgvListaProducto.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
			listar();
            CargarCategorias();
			DesactivarCampos();
        }
